...
<script>
	...
	function sweetalrt(id,page) {
		...
		swal({
				title: "Are you sure?",
				text: "Once deleted, you will not be able to recover this imaginary Category Data!",
				icon: "warning",
				buttons: true,
				dangerMode: true,
			})
				...
				if (willDelete) {
					$.ajax({
						...
						success: function (cat_data) {
							//alert(cat_data);
							if (cat_data == 0) {
								$('#cat_' + id).html(cat_data);
								p=$("#page").val();
								pagination(p);
							}
						}
					});
					swal("Poof! Your imaginary Category data has been deleted!", {
						icon: "success",
					});
				} else {
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-right">
							<a href="add_category.php" class="btn btn-primary btn-sm scroll-click" rel="content-y" role="button"><i class="fa fa-code"></i>Add Category</a>
						</div>
					</div>
