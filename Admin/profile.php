					...
					<div class="dropdown-menu dropdown-menu-right">
						<div class="notification-list mx-h-350 customscroll">
							<ul>
								<li>
									<a href="#">
										<img src="vendors/images/1.png" alt="">
										<h3>devanshi@gmail.com</h3>
	...
	<div class="right-sidebar">
		<div class="sidebar-title">
			<h3 class="weight-600 font-16 text-blue">
				Layout Settings
				<span class="btn-block font-weigt-400 font-12">User Interface Settings</span>
			</h3>
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-30">
						<div class="pd-20 card-box height-100-p">
							<div class="profile-photo">
								...
								<img src="vendors/images/1.png" alt="" class="avatar-photo"  height="120px" width="120px">
								<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
									<div class="modal-dialog modal-dialog-centered" role="document">
										<div class="modal-content">
											<div class="modal-body pd-5">
												<div class="img-container">
													<img id="image" src="vendors/images/1.jpg" alt="Picture">
												</div>
											</div>
							...
							<h5 class="text-center h5 mb-0"><?php 
							if(isset($_SESSION['email']))
							{
								echo $_SESSION['email'];
							}
