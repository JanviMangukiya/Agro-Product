...
<script>
	...
	function sweetalrt(id,page) {
		...
		swal({
				title: "Are you sure?",
				text: "Once deleted, you will not be able to recover this imaginary Banner Data!",
				icon: "warning",
				buttons: true,
				dangerMode: true,
			})
			.then((willDelete) => {
				if (willDelete) {
					...
					swal("Poof! Your imaginary banner data has been deleted!", {
						icon: "success",
					});
				} else {
					swal("Your imaginary Banner data is safe!");
				}
			});
	}
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-right">
							<a href="add_banner.php" class="btn btn-primary btn-sm scroll-click" rel="content-y"
								role="button"><i class="fa fa-code"></i>Add Banner</a>
						</div>
					</div>
								...
								<tr id="ban_<?php echo $data['banner_id'] ?>">
									...
									<td>
										<button type="button" class="btn btn-danger"
											onclick="sweetalrt(<?php echo $data['banner_id'] ?>,<?php echo $page?>)"><i
